...
MS.Views.TrackList = function() {
   ...
   /* ELEMENTS */
   me.window          = E.window();
   me.listContainer   = E.scrollView('20%', '80%');
   ...
   me.prevTrackLabel  = E.label('Prev', '13%', '10%');
   me.playPauseLabel  = E.label((typeof C.CurrentTrack != 'undefined') ? 'Pause' : 'Play', '13%', '43%');
   me.nextTrackLabel  = E.label('Next', '13%', '78%');

   // Fetch Track Data & Add List Items to View
   T.buildTrackList(me.listContainer, null);

   /* ADD ELEMENTS TO WINDOW */
   me.elements = [me.homeLabel,me.listContainer, me.prevTrackLabel, me.playPauseLabel, me.nextTrackLabel];
