...
@interface WOA_Music_StreamObject : KrollCoverageObject {
#else
@interface WOA_Music_StreamObject : KrollObject {
#endif
@private
...
extern NSString * WOA_Music_Stream$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WOA_Music_StreamObject *_woa_music_stream;
    KrollObject* console;
	BOOL shutdown;
