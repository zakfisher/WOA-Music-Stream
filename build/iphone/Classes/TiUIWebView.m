...
static NSString * const kWOA_Music_StreamJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_woa_music_streamInjection
{
	...
	[html appendString:kWOA_Music_StreamJavascript];
...
{
	// attempt to make well-formed HTML and inject in our WOA_Music_Stream bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _woa_music_streamInjection]];
