 ...
 * Copyright (c) 2009-2011 by WOA_Music_Stream, Inc. All Rights Reserved.
...
//@interface WOA_Music_StreamObject : NSObject
//@end

@interface WOA_Music_StreamObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WOA_Music_StreamObject class]])
		{
			for (NSString *key in [[(WOA_Music_StreamObject*)o modules] allKeys])
			{
