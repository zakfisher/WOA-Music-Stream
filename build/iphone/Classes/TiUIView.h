...
/**
 Base class for all WOA_Music_Stream views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WOA_Music_Stream view hierarchy (such as wrapped iOS UIViews) was touched.
