...
//Rare exceptions to indicate a bug in the _woa_music_stream code (Eg, function that a subclass should have implemented)
...
/**
 The base class for WOA_Music_Stream proxies.
 */
