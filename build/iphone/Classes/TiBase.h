...
// in simulator we redefine to format for WOA_Music_Stream Developer console
...
{\
	NSString * exceptionName = [@"org.woa_music_stream." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.woa_music_stream";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWOA_Music_StreamNativeItemNone = -1, 
	UIWOA_Music_StreamNativeItemSpinner = -2,
	UIWOA_Music_StreamNativeItemProgressBar = -3,
	
	UIWOA_Music_StreamNativeItemSlider = -4,
	UIWOA_Music_StreamNativeItemSwitch = -5,
	UIWOA_Music_StreamNativeItemMultiButton = -6,
	UIWOA_Music_StreamNativeItemSegmented = -7,
	
	UIWOA_Music_StreamNativeItemTextView = -8,
	UIWOA_Music_StreamNativeItemTextField = -9,
	UIWOA_Music_StreamNativeItemSearchBar = -10,
	
	UIWOA_Music_StreamNativeItemPicker = -11,
	UIWOA_Music_StreamNativeItemDatePicker = -12,
	
	UIWOA_Music_StreamNativeItemInfoLight = -13,
	UIWOA_Music_StreamNativeItemInfoDark = -14,
	
	UIWOA_Music_StreamNativeItemDisclosure = -15,
	
	UIWOA_Music_StreamNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WOA_Music_Stream instances of
