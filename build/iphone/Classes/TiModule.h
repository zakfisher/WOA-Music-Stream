...
/**
 The base class for all WOA_Music_Stream modules
 */
...
/**
 WOA_Music_Stream Platform calls this method on startup.
 */
-(void)startup;

/**
 WOA_Music_Stream Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 WOA_Music_Stream Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 WOA_Music_Stream Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 WOA_Music_Stream Platform calls this method on resume.
 @param sender The sender of the event.
 */
